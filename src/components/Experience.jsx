...
function Experience({ cvData, onChange }) {
  return (
    <section className="experience-info">
      ...
      <label htmlFor="input-responsibilities">
        Main Responsibilities of your Work:
      </label>
      <textarea
        id="input-responsibilities"
      ...
      <div className="experience-start-date">
        ...
        <input
          id="input-experience-start-date"
